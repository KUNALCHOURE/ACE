...
const createDiscussion = asynchandler(async (req, res) => {
    ...
    // Fire-and-forget embedding — failure must never crash the request
    embedDiscussion(newDiscussion).catch((err) => {
        console.error('[createDiscussion] embedding dispatch failed:', err?.message || err);
    });
